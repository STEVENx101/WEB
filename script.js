...
// Function to hide the invoice content and show the shop content
function hideInvoice() {
    // Change the header text to "Shop"
    invoiceHeader.innerText = "Shop";
    // Remove the "invisible" class from the shop content
    productContent.classList.remove("invisible");
    // Add the "invisible" class to the invoice content to hide it
